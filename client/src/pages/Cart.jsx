...
const Cart = () => {
  ...
  return cartProductsFreq.length ===0 ? (
    <Card className="w-72 lg:max-w-screen-sm mx-auto text-center mt-10 bg-slate-400">
      <h1 className="lg:text-2xl font-serif">No Product Available in Your Cart</h1>
      <Button
    ...
    <div className="flex flex-col my-4 mx-2 md:mx-32">
      <h1 className="text-[16px] lg:text-xl font-serif font-semibold text-white text-center">Cart</h1>
