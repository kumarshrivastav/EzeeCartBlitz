...
const userRegistrationFields = [
  ...
  check("password", "password is required with minimum 8 characters").isLength({
    min: 8,
  }),
];
...
userRouter.post(
  "/currentpwdstatus/:userId",
  verifyToken,
  userController.currentPwdStatus
);
userRouter.put(
...
userRouter.put(
  "/resetpasswordbygmail/:email",
  userController.resetUserPasswordByGmail
);
